...
const INSIGHTS = {
  ...
  insight:"HRV is up 6ms from yesterday and WHOOP recovery sits at 74% — your CNS is primed for a strong session. All programming today is L5-S1 fusion safe: no spinal loading, no sudden bending. Extended warm-up protocol active. Hit everything hard within your safe range.",
  workout:{
    focus:"Chest & Arms + L5-S1 Safe Core", duration:"70–80 min", intensity:"High",
    warmup:"10 min mandatory warm-up: 5 min incline walk → cat-cow ×15 → bird-dog ×10 each side → glute bridges ×20 → resistance band pull-aparts ×20. DO NOT skip — L5-S1 must be warm before any loading.",
    exercises:[
      {name:"Flat Barbell Bench Press",       sets:5, reps:"4–6",    rest:"3 min", note:"⭐ Priority lift — RPE 8-9, full ROM, controlled descent"},
      {name:"Incline DB Press",               sets:4, reps:"8–10",   rest:"2 min", note:"Upper chest emphasis, neutral spine throughout"},
      {name:"Cable Chest Fly",                sets:3, reps:"12–15",  rest:"90s",   note:"Seated — keeps spine neutral, no bending"},
      {name:"Seated DB Shoulder Press",       sets:4, reps:"8–10",   rest:"2 min", note:"Seated only — protects L5-S1 from compression"},
      {name:"Cable Lateral Raise",            sets:4, reps:"12–15",  rest:"75s",   note:"Drop set on last set, keep core braced"},
      {name:"45° Back Extension (bodyweight)",sets:3, reps:"12–15",  rest:"90s",   note:"🔴 BACK REBUILD — slow controlled, squeeze glutes at top, no hyperextension"},
      {name:"Cable Pull-Through",             sets:3, reps:"12–15",  rest:"90s",   note:"🔴 BACK REBUILD — hip hinge pattern, rebuilds posterior chain safely"},
      {name:"Barbell Hip Thrust",             sets:4, reps:"10–12",  rest:"2 min", note:"🔴 BACK REBUILD — glutes + lower back activation, no spinal compression"},
      {name:"EZ Bar Curl",                    sets:4, reps:"8–10",   rest:"90s",   note:"Seated on bench — strict form, no swinging"},
      {name:"Tricep Rope Pushdown",           sets:4, reps:"10–12",  rest:"75s",   note:"Elbows pinned, full extension"},
      {name:"Dead Bug",                       sets:3, reps:"10 each",rest:"60s",   note:"🔴 CORE — lower back flat on floor at all times"},
      {name:"Pallof Press",                   sets:3, reps:"12 each",rest:"60s",   note:"🔴 CORE — anti-rotation, builds deep spinal stabilizers"},
      {name:"Standing Calf Raise",            sets:4, reps:"15–20",  rest:"60s",   note:"Full ROM, pause at top, slow negative"},
    ],
    cooldown:"🔴 MANDATORY 10 min: Supine knee-to-chest stretch 3×30s each side → piriformis stretch → child's pose 60s → hip flexor stretch 45s each. Ice lower back 15 min if tight."
  },
  nutrition:{
    ...
    tips:[
      ...
      "Anti-inflammatory focus: add turmeric, omega-3s daily — supports L5-S1 recovery"
    ]
  },
  recovery:[
    "🔴 MORNING PROTOCOL: Before getting out of bed — 10 cat-cows, 10 glute bridges. Wakes up the stabilizers before gravity loads your spine",
    "Sleep with pillow between knees (side) or under knees (back) — keeps L5-S1 in neutral all night",
    "Heat pad on lower back 15 min before training — gets blood flow into the tight muscles before you load them",
    "Post-workout: ice 15 min if inflamed, heat 15 min if just tight — know the difference",
    "🔴 BACK REBUILDING: The muscles NEED work to stop atrophying — bird-dog and glute bridges daily even on rest days, takes 5 min",
    "Track today's back feel: 1-10 scale. Over weeks you'll see what causes tight days vs good days"
  ]
};
